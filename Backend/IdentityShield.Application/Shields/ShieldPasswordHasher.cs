...
{
    public class ShieldPasswordHasher(IOptions<ShieldOptions> options) : IPasswordHasher<ShieldUser>
    {
        public string HashPassword(ShieldUser user, string password)
        {
            return Hash(password);
        }

        public PasswordVerificationResult VerifyHashedPassword(ShieldUser user, string hashedPassword, string providedPassword)
        {
