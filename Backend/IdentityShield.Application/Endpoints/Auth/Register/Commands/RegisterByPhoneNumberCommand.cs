...
namespace IdentityShield.Application.Endpoints.Auth.Register.Commands
{
    public static class RegisterByPhoneNumberCommand
    {
                             ...
                             JwtTokenProvider<ShieldUser> _jwtTokenProvider) : IEndPointRequestHandler<Command>
        {
            ...
            {
                ShieldUser? user = await _userManager.FindByPhoneNumberAsync(request.Request.PhoneNumber);
                ...
                await _userManager.SendSMSNotificationAsync(user, Constant.Purposes.Register, TimeSpan.FromHours(24));
