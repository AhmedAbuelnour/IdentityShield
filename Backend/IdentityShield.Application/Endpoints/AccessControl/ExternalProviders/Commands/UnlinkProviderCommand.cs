...
namespace IdentityShield.Application.Endpoints.AccessControl.ExternalProviders.Commands
{
    public static class UnlinkProviderCommand
    {
        ...
        public class Handler(ShieldUserManager _userManager) : IEndPointRequestHandler<Command>
        {
            public async Task<IResult> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                if (await _userManager.UnlinkProviderAsync(user, request.Request.Name) is IdentityResult identityResult
